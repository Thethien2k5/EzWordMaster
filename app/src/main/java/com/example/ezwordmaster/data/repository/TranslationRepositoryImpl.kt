...
class TranslationRepositoryImpl @Inject constructor(
    ...
    override suspend fun translateText(text: String, sourceLang: String, targetLang: String): DetailedTranslationResult {
    ...
    private suspend fun saveTranslationHistory(originalText: String, result: DetailedTranslationResult) {
        try {
