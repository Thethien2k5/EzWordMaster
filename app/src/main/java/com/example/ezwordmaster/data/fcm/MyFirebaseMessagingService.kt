...
import com.example.ezwordmaster.utils.NotificationSettings // <--- IMPORT FILE ĐÚNG
...
class MyFirebaseMessagingService : FirebaseMessagingService() {
    ...
    override fun onCreate() {
        ...
        notificationRepository = (application as NotificationSettings).appContainer.notificationRepository
        // ######################################
    }
